    ...
    getMenuHaphiengItems(){
        ...
        [   //first group
            {path: null, name: "ENTRIES", level: 1, group: "3050"},
             { path: "/home/salesEntries", name: "Sales Entry", level: 2, group: "3050" },
             { path: "/home/salesReturnEntries", name: "Sales Return Entry", level: 2, group: "3050" },
             { path: "/home/purchaseEntries", name: "Purchase Entry", level: 2, group: "3050" },
             { path: "/home/purchaseReturnEntries", name: "Purchase Return Entry", level: 2, group: "3050" },
             { path: "/home/invQuantityAdjEntries", name: "Inventory Quantity Adjustment Entry", level: 2, group: "3050" },
             { path: "/home/invDamageEntries", name: "Inventory Damage Entry", level: 2, group: "3050" },
             { path: "/home/transferringStockEntries", name: "Transferring Stock Entry", level: 2, group: "3050" },
             { path: "/home/generateSalesCounterReceipts", name: "Generate Sales Counter Receipts", level: 2, group: "3050" },
             { path: "/home/collectionFromCustomersEntries", name: "Collection from Customers Entry", level: 2, group: "3050" },
             { path: "/home/paymentToSuppliersEntries", name: "Payment to Suppliers Entry", level: 2, group: "3050" },
            //secnd group
            ...
            {path: null, name: "TOOLS", level: 1, group: "3080"},
             { path: "/home/viewEditSales", name: "View Sales", level: 2, group: "3080" },
             { path: "/home/viewEditSalesReturns", name: "View Sales Returns", level: 2, group: "3080" },
             { path: "/home/viewEditPurchases", name: "View Purchases", level: 2, group: "3080" },
             { path: "/home/viewEditPurchasesReturns", name: "View Purchases Returns", level: 2, group: "3080" },
             { path: "/home/viewEditCounterReceipts", name: "View Counter Receipts", level: 2, group: "3080" },
             { path: "/home/viewEditQuantityStockAdjustments", name: "View Quantity Stock Adjustments", level: 2, group: "3080" },
             { path: "/home/viewEditInventoryDamages", name: "View Inventory Damages", level: 2, group: "3080" },
